...
if __name__ == '__main__':
    ...
    truncate_genome_from_target(infile=join(indir,"gene.infile"),
                                indir=join(example_dir,"raw_gbk"),
                                odir=join(indir,"example_out"),
                                suffix="gbk",
                                fuzzy_match=False,
                                num_p="50p",
                                force=False)
    # python3 ./extra_bin/truncate_genome_from_target.py -i ./example_data/truncate_genome_from_target/gene.infile -indir ./example_data/truncate_genome_from_target/raw_gbk/ -odir ./example_data/truncate_genome_from_target/split_gbk -f -r 50p
